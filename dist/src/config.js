...
const EVOLUTION_INTERVAL = parseInt(process.env.ZCRYSTAL_EVOLUTION_INTERVAL || '3600000', 10);
const HEARTBEAT_INTERVAL = parseInt(process.env.ZCRYSTAL_HEARTBEAT_INTERVAL || '300000', 10);
const PROACTIVE_INTERVAL = parseInt(process.env.ZCRYSTAL_PROACTIVE_INTERVAL || '600000', 10);
export const config = {
    paths: {
        home: HOME,
